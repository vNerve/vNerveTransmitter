...
extern PROTOBUF_INTERNAL_EXPORT_vNerve_2fbilibili_2flive_2fuser_5fmessage_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<8> scc_info_UserMessage_vNerve_2fbilibili_2flive_2fuser_5fmessage_2eproto;
namespace vNerve {
namespace bilibili {
namespace live {
