...
#include "vNerve/bilibili/info/info.pb.h"
...
extern PROTOBUF_INTERNAL_EXPORT_vNerve_2fbilibili_2finfo_2finfo_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto;
namespace vNerve {
namespace bilibili {
...
static void InitDefaultsscc_info_BilibiliCollection_vNerve_2fbilibili_2finfo_2finfo_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_BilibiliCollection_vNerve_2fbilibili_2finfo_2finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_BilibiliCollection_vNerve_2fbilibili_2finfo_2finfo_2eproto}, {
      &scc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto.base,}};

static void InitDefaultsscc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto}, {}};

static void InitDefaultsscc_info_GetAllBilibiliInfosRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetAllBilibiliInfosRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetAllBilibiliInfosRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto}, {}};

static void InitDefaultsscc_info_GetBilibiliInfoByUidRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetBilibiliInfoByUidRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetBilibiliInfoByUidRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_vNerve_2fbilibili_2finfo_2finfo_2eproto[4];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_vNerve_2fbilibili_2finfo_2finfo_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_vNerve_2fbilibili_2finfo_2finfo_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_vNerve_2fbilibili_2finfo_2finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_vNerve_2fbilibili_2finfo_2finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_sccs[4] = {
  &scc_info_BilibiliCollection_vNerve_2fbilibili_2finfo_2finfo_2eproto.base,
  &scc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto.base,
  &scc_info_GetAllBilibiliInfosRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto.base,
  &scc_info_GetBilibiliInfoByUidRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_once;
static bool descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto = {
  &descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_initialized, descriptor_table_protodef_vNerve_2fbilibili_2finfo_2finfo_2eproto, "vNerve/bilibili/info/info.proto", 993,
  &descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_once, descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_sccs, descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto_deps, 4, 0,
  schemas, file_default_instances, TableStruct_vNerve_2fbilibili_2finfo_2finfo_2eproto::offsets,
  file_level_metadata_vNerve_2fbilibili_2finfo_2finfo_2eproto, 4, file_level_enum_descriptors_vNerve_2fbilibili_2finfo_2finfo_2eproto, file_level_service_descriptors_vNerve_2fbilibili_2finfo_2finfo_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_vNerve_2fbilibili_2finfo_2finfo_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto), true);
namespace vNerve {
namespace bilibili {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LiveStatus_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_vNerve_2fbilibili_2finfo_2finfo_2eproto);
  return file_level_enum_descriptors_vNerve_2fbilibili_2finfo_2finfo_2eproto[0];
}
...
const GetAllBilibiliInfosRequest& GetAllBilibiliInfosRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetAllBilibiliInfosRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto.base);
...
const GetBilibiliInfoByUidRequest& GetBilibiliInfoByUidRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetBilibiliInfoByUidRequest_vNerve_2fbilibili_2finfo_2finfo_2eproto.base);
  return *internal_default_instance();
}
...
void BilibiliCollection::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_BilibiliCollection_vNerve_2fbilibili_2finfo_2finfo_2eproto.base);
}
...
void BilibiliInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_BilibiliInfo_vNerve_2fbilibili_2finfo_2finfo_2eproto.base);
  uuid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  uname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  room_title_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  description_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
