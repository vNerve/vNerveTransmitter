 ...
 * @constructor
 */
proto.vNerve.bilibili.live.UserKickedOutMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.vNerve.bilibili.live.UserKickedOutMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.vNerve.bilibili.live.UserKickedOutMessage.displayName = 'proto.vNerve.bilibili.live.UserKickedOutMessage';
}
...
proto.vNerve.bilibili.live.UserMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    userKickedOut: (f = msg.getUserKickedOut()) && proto.vNerve.bilibili.live.UserKickedOutMessage.toObject(includeInstance, f)
  };
...
/**
 * @param {?proto.vNerve.bilibili.live.UserKickedOutMessage|undefined} value
 * @return {!proto.vNerve.bilibili.live.UserMessage} returns this
*/
 ...
 * @return {!proto.vNerve.bilibili.live.UserMessage} returns this
 */
proto.vNerve.bilibili.live.UserMessage.prototype.clearUserKickedOut = function() {
  return this.setUserKickedOut(undefined);
};
 ...
 * @return {!Object}
 */
proto.vNerve.bilibili.live.UserKickedOutMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.vNerve.bilibili.live.UserKickedOutMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.vNerve.bilibili.live.UserKickedOutMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.vNerve.bilibili.live.UserKickedOutMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.vNerve.bilibili.live.UserKickedOutMessage}
 */
proto.vNerve.bilibili.live.UserKickedOutMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.vNerve.bilibili.live.UserKickedOutMessage;
  return proto.vNerve.bilibili.live.UserKickedOutMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.vNerve.bilibili.live.UserKickedOutMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.vNerve.bilibili.live.UserKickedOutMessage}
 */
proto.vNerve.bilibili.live.UserKickedOutMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.vNerve.bilibili.live.UserKickedOutMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.vNerve.bilibili.live.UserKickedOutMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.vNerve.bilibili.live.UserKickedOutMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.vNerve.bilibili.live.UserKickedOutMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
