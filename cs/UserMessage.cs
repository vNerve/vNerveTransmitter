...
namespace VNerve.Bilibili.Live {
    ...
    static UserMessageReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "eWxvYWQi2gIKCFVzZXJJbmZvEgsKA3VpZBgBIAEoBBIMCgRuYW1lGAIgASgJ",
            ...
            "YWxJbmZvEhMKC2d1YXJkX2xldmVsGAsgASgFEhYKDnBob25lX3ZlcmlmaWVk",
            "GAwgASgIEhQKDHJlZ3VsYXJfdXNlchgNIAEoCEIJCgdtYWludmlwIo8BCglN",
            "ZWRhbEluZm8SEgoKbWVkYWxfbmFtZRgBIAEoCRITCgttZWRhbF9sZXZlbBgC",
            "IAEoDRITCgttZWRhbF9jb2xvchgDIAEoBxIUCgxzdHJlYW1lcl91aWQYBCAB",
            "KAQSFQoNc3RyZWFtZXJfbmFtZRgFIAEoCRIXCg9zdHJlYW1lcl9yb29taWQY",
            "BiABKA0iYQoORGFubWFrdU1lc3NhZ2USDwoHbWVzc2FnZRgBIAEoCRI+Cgxs",
            "b3R0ZXJ5X3R5cGUYAiABKA4yKC52TmVydmUuYmlsaWJpbGkubGl2ZS5Mb3R0",
            "ZXJ5RGFubWFrdVR5cGUitAEKEFN1cGVyQ2hhdE1lc3NhZ2USDwoHbWVzc2Fn",
            "ZRgBIAEoCRINCgVwcmljZRgCIAEoDRIKCgJpZBgDIAEoDRINCgV0b2tlbhgE",
            "IAEoCRIRCglwcmljZV9jbnkYBSABKA0SEgoKcHJpY2VfY29pbhgGIAEoDRIY",
            "ChBsYXN0aW5nX3RpbWVfc2VjGAcgASgNEhIKCnN0YXJ0X3RpbWUYCCABKAQS",
            "EAoIZW5kX3RpbWUYCSABKAQicAoLR2lmdE1lc3NhZ2USDwoHaXNfZ29sZBgB",
            "IAEoCBISCgp0b3RhbF9jb2luGAIgASgNEg8KB2dpZnRfaWQYAyABKA0SEQoJ",
            "Z2lmdF9uYW1lGAQgASgJEhgKEGdpZnRfc2luZ2xlX2NvaW4YBSABKA0iUwoR",
            "V2VsY29tZVZJUE1lc3NhZ2USLwoDdmlwGAEgASgOMiIudk5lcnZlLmJpbGli",
            "aWxpLmxpdmUuTGl2ZVZpcExldmVsEg0KBWFkbWluGAIgASgIIkYKE1dlbGNv",
            "bWVHdWFyZE1lc3NhZ2USLwoFZ3VhcmQYASABKA4yIC52TmVydmUuYmlsaWJp",
            "bGkubGl2ZS5HdWFyZExldmVsIlAKD05ld0d1YXJkTWVzc2FnZRIvCgVsZXZl",
            "bBgBIAEoDjIgLnZOZXJ2ZS5iaWxpYmlsaS5saXZlLkd1YXJkTGV2ZWwSDAoE",
            "Y29pbhgCIAEoDSIUChJVc2VyQmxvY2tlZE1lc3NhZ2UiFgoUVXNlcktpY2tl",
            "ZE91dE1lc3NhZ2UqMwoMTGl2ZVZpcExldmVsEgoKBk5PX1ZJUBAAEgsKB01P",
            "TlRITFkQARIKCgZZRUFSTFkQAio8ChJMb3R0ZXJ5RGFubWFrdVR5cGUSDgoK",
            "Tk9fTE9UVEVSWRAAEgkKBVNUT1JNEAESCwoHTE9UVEVSWRACKj4KCkd1YXJk",
            "TGV2ZWwSDAoITk9fR1VBUkQQABIKCgZMRVZFTDEQARIKCgZMRVZFTDIQAhIK",
            "CgZMRVZFTDMQA0ID+AEBYgZwcm90bzM="));
  ...
  public sealed partial class UserInfo : pb::IMessage<UserInfo> {
    ...
    public int CalculateSize() {
      ...
      if (GuardLevel != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(GuardLevel);
      }
      if (PhoneVerified != false) {
        size += 1 + 1;
      }
  ...
  public sealed partial class WelcomeVIPMessage : pb::IMessage<WelcomeVIPMessage> {
    ...
    private global::VNerve.Bilibili.Live.LiveVipLevel vip_ = global::VNerve.Bilibili.Live.LiveVipLevel.NoVip;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::VNerve.Bilibili.Live.LiveVipLevel Vip {
      get { return vip_; }
      set {
        vip_ = value;
      }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Vip != global::VNerve.Bilibili.Live.LiveVipLevel.NoVip) hash ^= Vip.GetHashCode();
      if (Admin != false) hash ^= Admin.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (Vip != global::VNerve.Bilibili.Live.LiveVipLevel.NoVip) {
        output.WriteRawTag(8);
        output.WriteEnum((int) Vip);
      }
      if (Admin != false) {
        output.WriteRawTag(16);
        output.WriteBool(Admin);
    ...
    public int CalculateSize() {
      int size = 0;
      if (Vip != global::VNerve.Bilibili.Live.LiveVipLevel.NoVip) {
        size += 1 + pb::CodedOutputStream.ComputeEnumSize((int) Vip);
      }
      if (Admin != false) {
        size += 1 + 1;
      }
    ...
    public void MergeFrom(WelcomeVIPMessage other) {
      ...
      if (other.Vip != global::VNerve.Bilibili.Live.LiveVipLevel.NoVip) {
        Vip = other.Vip;
      }
      if (other.Admin != false) {
        Admin = other.Admin;
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            Vip = (global::VNerve.Bilibili.Live.LiveVipLevel) input.ReadEnum();
            break;
          }
          case 16: {
            Admin = input.ReadBool();
  ...
  public sealed partial class WelcomeGuardMessage : pb::IMessage<WelcomeGuardMessage> {
    ...
    public const int GuardFieldNumber = 1;
    private global::VNerve.Bilibili.Live.GuardLevel guard_ = global::VNerve.Bilibili.Live.GuardLevel.NoGuard;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::VNerve.Bilibili.Live.GuardLevel Guard {
      get { return guard_; }
      set {
        guard_ = value;
      }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Guard != global::VNerve.Bilibili.Live.GuardLevel.NoGuard) hash ^= Guard.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (Guard != global::VNerve.Bilibili.Live.GuardLevel.NoGuard) {
        output.WriteRawTag(8);
    ...
    public void MergeFrom(WelcomeGuardMessage other) {
      ...
      if (other.Guard != global::VNerve.Bilibili.Live.GuardLevel.NoGuard) {
        Guard = other.Guard;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            Guard = (global::VNerve.Bilibili.Live.GuardLevel) input.ReadEnum();
            break;
          }
        }
      }
